          ...
          <div className="grid items-center gap-10 lg:grid-cols-2">
            <div>
              <h1 className="text-4xl font-extrabold leading-tight text-slate-900 sm:text-5xl md:text-6xl lg:text-7xl">
                Smart Campus <span className="text-blue-600">Operations</span>
                <br />
                Hub
              </h1>
            ...
            <div className="relative">
              ...
              <div className="rounded-2xl bg-gradient-to-br from-blue-50 to-slate-50 p-8 shadow-xl ring-1 ring-slate-200">
                <div className="space-y-4">
                  <div className="flex items-center rounded-lg bg-white p-4 shadow-sm">
                    ...
                    <div className="ml-4">
                      <div className="font-semibold text-slate-900">Facilities Management</div>
                  ...
                  <div className="flex items-center rounded-lg bg-white p-4 shadow-sm">
                    ...
                    <div className="ml-4">
                      <div className="font-semibold text-slate-900">Smart Bookings</div>
                      <div className="text-sm text-slate-500">Conflict-free scheduling</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center rounded-lg bg-white p-4 shadow-sm">
                    ...
                    <div className="ml-4">
                      <div className="font-semibold text-slate-900">Ticket System</div>
                      <div className="text-sm text-slate-500">Quick issue resolution</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute -bottom-4 right-6 z-10 rounded-xl bg-blue-600 px-5 py-3 text-white shadow-lg">
                ...
                <div className="text-xs text-blue-100">Always Available</div>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="mt-3 text-slate-600">
                    Role-based permissions for Users, Admins, and Technicians. Secure and efficient access management.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-2xl bg-slate-50 p-8 shadow-sm ring-1 ring-slate-200 hover:shadow-md transition">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="mt-3 text-slate-600">
                    Request, approve, and manage facility bookings with intelligent conflict detection and prevention.
                  </p>
                </div>
              </div>
            </div>
